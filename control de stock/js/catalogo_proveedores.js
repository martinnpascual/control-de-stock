...
function imprimirProveedores(){
  ...
  function eliminarProveedor(indiceActual){    
    let respuesta = window.confirm("¿Esta seguro de que desea eliminar este proveedor?");
  ...
  function abrirPopupModificarProveedor(indiceActual) {
    ...
    document.getElementById("razonSocial").value = catalogoProveedores[indiceActual].razonSocial;
  ...
  function modificarProveedor(){
    ...
    if((document.getElementById("nombre").value=="")||(document.getElementById("razonSocial").value=="")||(document.getElementById("direccion").value=="")||(document.getElementById("email").value=="")||(document.getElementById("telefono").value=="")){
      return false;
    }

    catalogoProveedores[indiceParaModificar].nombre = document.getElementById("nombre").value;
    catalogoProveedores[indiceParaModificar].apellido = document.getElementById("razonSocial").value;
  ...
  function agregarProveedor(){
    ...
    proveedorNuevo.razonSocial = document.getElementById("razonSocial").value;
