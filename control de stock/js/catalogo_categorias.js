                ...
                <div class="itemInformacion producto">
                      <div class="parteIzquierdaitemInformacion">
                        ...
                        <div class="descripcionProducto">
                          <ul>
                            <li>Descripción:  ${categoriaActual.productos[x].descripcion}</li>
...
function eliminarCategoria(indiceCategoriaActual){
  ...
  let respuesta = window.confirm("¿Esta seguro de que desea eliminar esta categoria?");
  if (respuesta){ 
...
function eliminarProducto(indiceCategoriaActual, indiceProductoActual){
  let respuesta = window.confirm("¿Esta seguro de que desea eliminar este producto?");
...
function agregarProducto(){
  ...
  if((document.getElementById("presentacion").value=="")||(document.getElementById("codigo").value=="")||(document.getElementById("nombre").value=="")||(document.getElementById("categoria").value=="")||(document.getElementById("descripcion").value=="")||(document.getElementById("precioEntradas").value=="")||(document.getElementById("precioSalidas").value=="")||(document.getElementById("unidades").value=="")||(document.getElementById("cantidadMinimaDisponibleInventario").value=="")){
    return false;
  }
...
function modificarProducto(){
  ...
  if((document.getElementById("codigo").value=="")||(document.getElementById("nombre").value=="")||(document.getElementById("categoria").value=="")||(document.getElementById("descripcion").value=="")||(document.getElementById("precioEntradas").value=="")||(document.getElementById("precioSalidas").value=="")||(document.getElementById("unidades").value=="")||(document.getElementById("cantidadMinimaDisponibleInventario").value=="")){
    return false;
  }
